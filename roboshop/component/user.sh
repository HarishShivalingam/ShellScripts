...
sed -i -e 's/MONGO_ENDPOINT/mongodb.devops2021.tk/' -e 's/REDIS_ENDPOINT/redis.devops2021.tk/' /home/roboshop/user/systemd.service && mv /home/roboshop/user/systemd.service /etc/systemd/system/user.service
stat $?
